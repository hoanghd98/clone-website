          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="md:w-1/3 bg-blue-900 text-white p-8 md:p-12">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-semibold text-blue-200 mb-2">Công ty TNHH DV Hàng Hải & Vận Tải Biển IMOSES</h3>
                </div>
                
                <div className="flex items-start">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-4 mt-1 text-blue-300 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                  <p className="text-blue-100">B1.17 the Brigdeview, Trần Trọng Cung, P.Tân Thuận Đông, Q7 - TP.HCM</p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-blue-100">(08) 62625331</p>
                    <p className="text-blue-100">0983 117 250</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-blue-100">business@imoses.com.vn</p>
                    <p className="text-blue-100">info@imoses.com.vn</p>
                  </div>
                </div>
              </div>
            </div>
