            ...
            <div className="md:w-1/3 bg-primary text-primary-content p-8 md:p-12">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-white">Số 7, Đường Ngô Gia Tự, Phường 9, Thành phố Vũng Tàu, Tỉnh Bà Rịa - Vũng Tàu, Việt Nam</p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-white">hoangnguyen.nptsc@gmail.com</p>
                  </div>
                </div>
              </div>
            </div>
