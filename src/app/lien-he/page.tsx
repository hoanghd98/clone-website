          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="md:w-1/3 bg-blue-900 text-white p-8 md:p-12">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-semibold text-blue-200 mb-2">Công ty TNHH DV Hàng Hải & Vận Tải Biển NAM PHUONG</h3>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-blue-100">Số 7, Đường Ngô Gia Tự, Phường 9, Thành phố Vũng Tàu, Tỉnh Bà Rịa - Vũng Tàu, Việt Nam</p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-blue-100">0865 302 279</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-blue-100">hoangnguyen.nptsc@gmail.com</p>
                  </div>
                </div>
              </div>
            </div>
