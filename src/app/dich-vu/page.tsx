...
export const metadata = {
  title: "Dịch vụ | IMOSES",
  description: "Các dịch vụ của Công ty TNHH DV Hàng Hải & Vận Tải Biển IMOSES",
};
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            IMOSES cung cấp đa dạng các dịch vụ trong lĩnh vực hàng hải, vận tải biển, đóng tàu và logistics với chất lượng hàng đầu.
          </p>
        </div>
