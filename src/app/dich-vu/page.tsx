...
const services = [
  {
    ...
    image: "/images/services/sua-chua.png",
  },
  {
    id: "vat-tu",
    ...
    content: "Hiện nay, NAM PHƯƠNG đang là nhà phân phối vật tư tàu thủy, dầu khí chính hãng từ các doanh nghiệp dẫn đầu trên thế giới: Stauff, Caterpillar, Donaldson,... Với đặc thù ngành hàng hải đòi hỏi tiêu chuẩn chất lượng khắt khe, chúng tôi luôn đặt uy tín và chất lượng sản phẩm lên hàng đầu. Các sản phẩm do Nam Phương cung cấp không chỉ đáp ứng đầy đủ các tiêu chí về kỹ thuật, độ bền và an toàn mà còn được lựa chọn cẩn thận để đảm bảo hiệu suất cao nhất trong mọi điều kiện khắc nghiệt. Với mạng lưới phân phối rộng khắp và hệ thống hậu cần vững chắc, NAM PHƯƠNG cam kết mang đến sự hài lòng tuyệt đối cho khách hàng thông qua việc cung cấp các giải pháp vật tư tàu thủy và dầu khí chất lượng cao, góp phần vào sự thành công và phát triển bền vững của từng doanh nghiệp trong ngành hàng hải.",
    image: "/images/services/vat-tu.jpg",
  },
  {
    id: "thuc-pham",
    ...
    image: "/images/services/thuc-pham.png",
  },
  {
    id: "ho-tro",
    ...
    image: "/images/services/ho-tro.png",
  }
];
